            ...
            <Container>
              ...
              <Row>
                ...
                <Col xs="10" lg="8">
                  ...
                  <input id="search" value={this.props.search} valueOne={this.props.visibility} onChange={this.handleSearch} style={{ borderColor: 'Blue', width: '70%', borderStyle: 'solid', borderRadius: '25px', marginTop: '10px', marginBottom: '10px' }} placeholder="Search in FAQs" />
                </Col>
                <Col xs="1" lg="2" />
              </Row>
